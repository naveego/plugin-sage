...
namespace Plugin_Sage.API
{
    public class DispatchObject : IDisposable
    {
        ...
        private BindingFlags m_flgMethod = BindingFlags.Public | BindingFlags.Static | BindingFlags.IgnoreCase |
                                           BindingFlags.InvokeMethod;

        private BindingFlags m_flgGetProperty = BindingFlags.Public | BindingFlags.Static | BindingFlags.IgnoreCase |
                                                BindingFlags.GetProperty;

        private BindingFlags m_flgSetProperty = BindingFlags.Public | BindingFlags.Static | BindingFlags.IgnoreCase |
        ...
        public object InvokeMethodByRef(string sMethodName, object[] aryParams)
        {
            ...
            return m_object.GetType()
                .InvokeMember(sMethodName, m_flgMethod, null, m_object, aryParams, pmods, null, null);
        }
        ...
        {
            return m_object.GetType()
                .InvokeMember(sPropertyName, m_flgSetProperty, null, m_object, new object[] {oValue});
        }
